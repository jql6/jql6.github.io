...
class TestMinFunction(unittest.TestCase):
    def test_it_returns_min_number(self):
        ...
        self.assertEqual(find_min_n2(array1), minimum_number1)
        self.assertEqual(find_min_n2(array2), minimum_number2)

    def test_it_handles_empty_lists(self):
        self.assertEqual(find_min_n2([]), math.inf)

    def test_it_handles_lists_with_one_element(self):
        self.assertEqual(find_min_n2([-1]), -1)
